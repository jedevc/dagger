...
func (r *ScalarTypeDef) Kind(ctx context.Context) (TypeDefKind, error) {
	if r.kind != nil {
		return *r.kind, nil
	}
	q := r.query.Select("kind")
...
func (r *TypeDef) WithScalar(kind TypeDefKind, name string, opts ...TypeDefWithScalarOpts) *TypeDef {
