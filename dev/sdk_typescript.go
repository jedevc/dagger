...
func (t TypescriptSDK) withVersion(version string) TypescriptSDK {
	t.Version = version
	return t
}
...
func (t TypescriptSDK) Publish(
	...
	build := t.withVersion(version).nodeJsBase().
...
func (t TypescriptSDK) Bump(
	ctx context.Context,
	// +optional
	version string,
) (*dagger.Directory, error) {
	result := bumpSDK("typescript", version, t.Dagger.Source())
...
func (t TypescriptSDK) nodeJsBaseFromVersion(nodeVersion string) *dagger.Container {
	...
	src := bumpSDK("typescript", t.Version, t.Dagger.Source()).Directory(appDir)
